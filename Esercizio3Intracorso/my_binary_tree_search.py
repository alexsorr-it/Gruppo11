...
from StruttureDati.map.map_base import MapBase
from StruttureDati.tree.linked_binary_tree import LinkedBinaryTree
...
class TreeMap(LinkedBinaryTree, MapBase):
    ...
    if self.is_empty():
      ...
      if p.key() == k:
        ...
        if p.key() < k:
          ...
          leaf = self._add_left(p, item)         # inherited from LinkedBinaryTree
    if self._count1 % 2 == 0:
      self._my_rebalance()                 # hook for balanced tree subclasses
      self._count1 += 1
  ...
  def _my_rebalance(self):
    ...
    middle = len(lista) // 2
    k_mid = lista[middle]
    #hai la chiave dell'elemento che deve essere la nuova radice
    x = self._subtree_search(radice,k_mid) #restituisce la position della chiave k_mid a partire da "radice"
    lista1 = []
    lista2 = []
    it = self.__iter__()
    for i in it:
      if i < x.key():
        ...
        lista2.append((i, self.__getitem__(i)))
    lista1 = lista1[::-1]
    chiave_radice = x.key()
    ...
    self._attach(self.root(),tree1, tree2)
...
# TM.__setitem2__(10, "s")
# TM.__setitem2__(20, "t")
# TM.__setitem2__(30, "v")
# TM.__setitem2__(40, "v")
# TM.__setitem2__(50, "v")
# TM.__setitem2__(60, "v")
# TM.__setitem2__(70, "v")
# TM.__setitem2__(80, "v")
# TM.__setitem2__(90, "v")
# TM.__setitem2__(100, "v")
#
# TM.__delitem2__(70)
# TM.__delitem2__(60)
#
